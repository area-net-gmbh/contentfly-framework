...
class EnglishOnlyTest extends TestCase
{
    ...
    private const EXCEPTIONS = array(
        ...
        array('tests/Integration/Api/ReadPathApiTest.php', 'Gelöscht', 'the same legacy pim_log.mode value, written as test data to show /api/all (000-000-0075) and /api/deleted (000-000-0094) still report it'),
