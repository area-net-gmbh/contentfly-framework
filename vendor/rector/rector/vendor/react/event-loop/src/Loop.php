...
final class Loop
{
     ...
     */
    public static function addReadStream($stream, $listener): void
    {
     ...
     */
    public static function addWriteStream($stream, $listener): void
    {
        // create loop instance on demand (legacy PHP < 7 doesn't like ternaries in method calls)
        if (self::$instance === null) {
            self::get();
     ...
     */
    public static function futureTick($listener): void
    {
        // create loop instance on demand (legacy PHP < 7 doesn't like ternaries in method calls)
        if (self::$instance === null) {
            self::get();
     ...
     */
    public static function addSignal($signal, $listener): void
    {
        // create loop instance on demand (legacy PHP < 7 doesn't like ternaries in method calls)
        if (self::$instance === null) {
            self::get();
     ...
     */
    public static function removeSignal($signal, $listener): void
    {
        if (self::$instance !== null) {
