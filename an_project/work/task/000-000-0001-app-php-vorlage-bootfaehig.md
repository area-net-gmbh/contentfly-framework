...
## Acceptance criteria
- [ ] Entschieden und festgehalten, was `custom/app.php` sein soll: eine **schlanke Vorlage**
...
- [ ] `php bin/console.php list` läuft ohne Fatal Error durch.
- [ ] Die HTTP-Seite bootet mindestens so weit, dass eine Route antwortet.
- [ ] Was aus der Kundendatei entfernt oder ergänzt wurde, ist in
...
- [ ] Falls Konfiguration oder eine Datenbank für den Boot nötig sind: Der Weg dahin steht im
