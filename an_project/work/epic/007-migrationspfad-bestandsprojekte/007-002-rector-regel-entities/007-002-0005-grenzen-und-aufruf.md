...
## Acceptance criteria
- [ ] Der Aufruf steht als Befehl da, den man kopieren kann, mit `--dry-run` als erstem Schritt.
- [ ] Was die Regel abdeckt und was nicht, steht vollständig — je Punkt aus einem der vier vorigen Tasks belegt.
- [ ] Was ausserhalb von `Entity/` von Hand zu tun bleibt, ist aufgeführt; ein Projekt kann den Lauf nicht für vollständig halten.
- [ ] `007-004` kann den Text übernehmen, ohne ihn neu zu schreiben — er steht an einer Stelle, nicht an drei.
